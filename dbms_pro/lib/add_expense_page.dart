...
class _AddExpensePopupState extends State<AddExpensePopup> {
  ...
  Future<void> fetchCategories() async {
    ...
    final lowerDefaults = defaultCategories.map((e) => e.toLowerCase()).toSet();
    final userOnlyCategories = userCategories
        .where((cat) => !lowerDefaults.contains(cat.toLowerCase()))
        .toList();
    setState(() {
      allCategories = [...defaultCategories, ...userOnlyCategories];
    });
  }
