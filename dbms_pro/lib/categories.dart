...
class CategoriesPage extends StatefulWidget {
  ...
  const CategoriesPage({Key? key, required this.expenses}) : super(key: key);
...
class _CategoriesPageState extends State<CategoriesPage> {
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              if (newCategory.isNotEmpty &&
                  !_categories.any((c) => c.toLowerCase() == newCategory.toLowerCase())) {
                setState(() {
                  _categories.add(newCategory);
                });
              }
  ...
  @override
  Widget build(BuildContext context) {
    final sortedCategories = _categories.toList()..sort();
    ...
    return Scaffold(
      ...
      body: sortedCategories.isEmpty
          ? const Center(
              child: Text(
                'No categories yet. Add some expenses!',
