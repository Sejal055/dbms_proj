...
class NotificationPage extends StatelessWidget {
  ...
  // 2. Used const for all Color declarations inside the list
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // Custom AppBar similar to the design
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    // Action for notification icon on notification page (e.g., mark all read)
                  },
                ),
              ],
            ),
