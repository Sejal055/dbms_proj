...
//       stream: CombineLatestStream.list([expensesStream, historyStream]),
...
//         final List<TransactionItem> transactions = allDocs.map((doc) {
//           final data = doc.data() as Map<String, dynamic>;

//           final String name =
//               (data['expense_name'] ?? data['title'] ?? 'Unknown').toString();
//           final String category = (data['category'] ?? 'Uncategorized')
//               .toString();

//           final Timestamp? timestamp = (data['timestamp'] is Timestamp)
...
//           final num rawAmount = (data['expense_amount'] ?? data['amount'] ?? 0);
...
//     final Color iconBackgroundColor = transaction.isExpense
//         ? Colors.red.shade100
//         : Colors.green.shade100;
//     final Color iconColor = transaction.isExpense
//         ? Colors.red.shade600
...
//       final month = parts.isNotEmpty && parts[0].isNotEmpty
//           ? parts[0]
//           : 'Unknown';
