...
class _HomePageState extends State<HomePage> {
  ...
  // --- Combined Widget for Real-time Budget Card ---
  Widget _buildTotalBalanceCard() {
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, userSnapshot) {
        ...
        final monthlyBudget = (userData['monthly_budget'] ?? 0).toDouble();
        final initialAccountBalance = (userData['amount_in_account'] ?? 0)
            .toDouble();
        ...
        return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, expenseSnapshot) {
            ...
            final currentTotalBalance =
                initialAccountBalance + income - expense;
            final amountLeft = monthlyBudget - expense;
            final percentLeft = monthlyBudget <= 0
                ? 1.0
                : ((monthlyBudget - expense) / monthlyBudget).clamp(0.0, 1.0);
